import { HandThumbUpIcon, SpeakerWaveIcon, SpeakerXMarkIcon, XMarkIcon } from "@heroicons/react/24/outline"
...
function Modal() {
    ...
    return (
        <MuiModal open={showModal} onClose={handleClose} className="fixed !top-7 left-0 z-50 mx-auto w-full max-w-5xl overflow-hidden 
        overflow-y-scroll rounded-md scrollbar-hide">
            <>
                <button onClick={handleClose} className="modalButton absolute right-5 top-5 !z-40 h-9 w-9 
                ...
                <div className="relative pt-[56.25%]">
                    <ReactPlayer
                        // Add a fall back if the video is not showing, ex: url={`https://www.youtube.com/watch?v=${trailer}` || "path to gif/img/video"}
